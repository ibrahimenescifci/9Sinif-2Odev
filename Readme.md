...
**Cevap:** **Defterime çizdiğim grafiğin eğimi: 21,008 N/m**
...
**Cevap:** **Grafiğin eğim formülü: y=21,008x+0,275**
...
**Cevap**: **Eğimi -650 N/m olarak buldum.Videodaki değer: -640 N/m. Videodaki değere yakın.**
...
6. Grafiği defterinize çiziniz.Sonra size verdiğim google sheet örneğini kullanarak bilgisayar ile grafiği çiziniz. Değerler yakın mı? Google sheet dosyasının bağlantısını ver. [buraya bağlantı ver]( https://docs.google.com/spreadsheets/d/1EN3ygdIbARodt0gY0Hv_aHlIROaQPec7jJTng8QOS0c/edit#gid=0  ). 
